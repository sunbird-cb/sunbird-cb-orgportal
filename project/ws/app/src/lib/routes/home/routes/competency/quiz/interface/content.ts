export namespace NSContent {
  ...
  export type IPrimaryCategoryType =
    | 'Learning Resource'
    | 'Program'
    | 'Course Unit'
    | 'Course'
  ...
  export interface IContentMeta {
    ...
    primaryCategory: IPrimaryCategoryType
    visibility: string
    posterImage: string
    language: string[]
    resourceType: string
    ...
    reviewStatus: string
    streamingUrl: string[]
    competencies_v3: ICompetencyArray[]
    scoreCutoffType: string
    rejectComment: string
  }
  export enum EPrimaryCategoryType {
    Resource = 'Learning Resource',
    Program = 'Program',
    Collection = 'Course Unit',
    Course = 'Course',
    KBoard = 'Knowledge Board',
  ...
  export interface ICompetencyArray {
    id: string
    name: string
    description: string
    ...
    selectedLevelLevel: string
    selectedLevelName: string
    selectedLevelDescription: string
    selectedLevelSource: string
  }
}
